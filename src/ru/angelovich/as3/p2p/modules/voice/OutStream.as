...
public class OutStream extends NetStream {

    public function OutStream(streamName:String, connection:NetConnection, peerID:String = "connectToFMS") {
    ...
    private function onStatus(event:NetStatusEvent):void {
        trace("out stream:", event.info.code);
